...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { reactable_id: @reaction.reactable_id, reactable_type: @reaction.reactable_type, reaction_type: @reaction.reaction_type, user_id: @reaction.user_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { reactable_id: @reaction.reactable_id, reactable_type: @reaction.reactable_type, reaction_type: @reaction.reaction_type, user_id: @reaction.user_id } }
