...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { accepted: @friendship.accepted, from_user_id: @friendship.from_user_id, to_user_id: @friendship.to_user_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { accepted: @friendship.accepted, from_user_id: @friendship.from_user_id, to_user_id: @friendship.to_user_id } }
